...
const details = {
  lats: [{img: Lat1, width: 8, height: 20}, {img: Lat2, width: 8, height: 20}, {img: Lat3, width: 8, height: 20}],
  backLats: [{img: backLat1, width: 8, height: 20}, {img: backLat2, width: 8, height: 20},
    {img: backLat3, width: 8, height: 20}, [{img: backHalfLat1, width: 8, height: 20}, 
    {img: backHalfLat2, width: 8, height: 20}]],
  proppeler: {img: proppeler, width: 8, height: 20},
  body: [{img: body1, width: 20, height: 8}, {img: body2, width: 20, height: 8}, {img: body3, width: 20, height: 8}],
}
...
export const planeBurst = () => {
  ...
  const backLat = details.backLats[Math.floor(Math.random() * details.backLats.length)]
